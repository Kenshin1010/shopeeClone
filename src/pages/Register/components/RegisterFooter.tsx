    ...
    <TableFooter>
      <Container>
        <Grid container spacing={3}>
              ...
              <List>
                ...
                <ListItem>
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <Typography>Shopee Blog</Typography>
                  </Link>
                </ListItem>
                <ListItem>
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <Typography>Shopee Mall</Typography>
                  </Link>
                </ListItem>
                <ListItem>
                  <Link
                ...
                <ListItem>
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <Typography>Shopee Xu</Typography>
                  </Link>
                </ListItem>
                <ListItem>
                  <Link
          ...
          <Grid item xs={12} md={3}>
            <Box>
              <Typography variant="h6">VỀ SHOPEE</Typography>
              <List>
                <ListItem>
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <Typography>Giới Thiệu Về Shopee Việt Nam</Typography>
                  </Link>
                </ListItem>
                <ListItem>
                  <Link
                ...
                <ListItem>
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <Typography>Điều Khoản Shopee</Typography>
                  </Link>
                </ListItem>
                <ListItem>
                  <Link
                ...
                <ListItem>
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <Typography>Liên Hệ Với Truyền Thông</Typography>
                  </Link>
                </ListItem>
              </List>
            </Box>
          ...
          <Grid item xs={12} md={3}>
            <Box>
              <Typography variant="h6">ĐƠN VỊ VẬN CHUYỂN</Typography>
              <List>
                <ListItem>
                  <Link target="_blank" rel="noopener noreferrer">
                    <img
          ...
          <Grid item xs={12} md={3}>
            <Box>
              <Typography variant="h6">THEO DÕI CHÚNG TÔI TRÊN</Typography>
              <List>
                <ListItem>
                  <Link
        ...
        <Grid container spacing={2} className="VsoUpy">
          <Grid item xs={12} sm={6}>
            <Box sx={{ marginRight: 0, color: "rgba(25, 37, 55, 0.5)" }}>
          ...
          <Grid item xs={12} sm={6}>
            <Box>
              <Typography variant="body1">Quốc gia &amp; Khu vực:</Typography>
              <Box>
