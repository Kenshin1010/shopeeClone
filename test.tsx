            ...
            <Box  className="edit-row image-offset">
              ...
              >
                <Box
                  ...
                  sx=line-height: 40px; display: flex"
                >
                  <Box
                    ...
                    >
                      ...
                      >
                        <Box className="shopee-modal__container">
                          <Box className="shopee-modal__box" sx={{display: "none"}}>
                            <Box
                                  ...
                                  <Box  className="panel-left">
                                    ...
                                    <Box  className="actions-bar">
                                            ...
                                            <Box className="shopee-popover__ref">
                                              ...
                                              >
                                                <SvgIcon
                                                  ...
                                                  >
                                                    <path
                                                      d="M2.307 13.448a7.878 7.878 0 1111.525-.412l2.003 2.003a.563.563 0 11-.796.796l-2.003-2.003a7.878 7.878 0 01-10.729-.384zm10.675-1.15a6.753 6.753 0 10-.684.684l.366-.318.318-.366zM5.064 7.315h5.627a.563.563 0 010 1.125H5.064a.563.563 0 110-1.125z"
                                                    ></path></svg>
                                                    </SvgIcon>
                                              </Box>
                                            </Box>
                                            ...
                                            <Box className="shopee-popover__ref">
                                              ...
                                              >
                                                <SvgIcon
                                                  ...
                                                  >
                                                    <path
                                                      d="M2.307 13.448a7.878 7.878 0 1111.525-.412l2.003 2.003a.563.563 0 11-.796.796l-2.003-2.003a7.878 7.878 0 01-10.729-.384zm10.675-1.15a6.753 6.753 0 10-.684.684l.366-.318.318-.366zM7.315 7.315v-2.25a.563.563 0 011.125 0v2.25h2.251a.563.563 0 010 1.125h-2.25v2.251a.563.563 0 01-1.126 0v-2.25h-2.25a.563.563 0 110-1.126h2.25z"
                                                    ></path></svg>
                                                </SvgIcon>
                                              </Box>
                                            </Box>
                                      ...
                                      >
                                        ...
                                        >
                                          <Typography> Nhập Lại </Typography>
                                        </Button>
                                      </Box>
                                    </Box>
                                    <Box  className="mask">
              ...
              <Box  className="edit-main" sx={{display: "flex"}}>
                ...
                >
                  <Box
                    ...
                    className="shopee-image-manager image-lock"
                    sx="
                  >
                    <Box
                    ...
                    >
                      ...
                      >
                        ...
                        <Box
                          ...
                          className="image-item-custom-text"
                        >
                          (0/1)
                        </Box>
                      </Box>
                ...
                <Box  className="promotion-image-remark">
                  <Box
                    ...
                    className="promotion-image-remark-content"
                  >
                    <List >
              ...
              <Box  className="video-manager">
                <Box  className="main">
                  <Box
                    ...
                    accept="video/mp4"
                  >
                    <Box  className="shopee-upload" simple="true">
                ...
                <Box  className="video-manager-remark-content">
                  <List >
                    ...
                    <ListItem >
                      ...
                      xử lý. Video sẽ tự động hiển thị sau khi đã xử lý thành
                      công.
                    </ListItem>
                  </List>
                </Box>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Box
                        className="shopee-input__inner shopee-input__inner--large"
                      >
                        <Input
                          type="text"
                          placeholder="Tên sản phẩm + Thương hiệu + Model + Thông số kỹ thuật"
                        ...
                        <Box className="shopee-input__suffix">
                          <Typography className="shopee-input__suffix-split"></Typography>0/120
                        </Box>
                      </Box>
                    </Box>
                  </Box>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Box
                    ...
                    className="product-edit-form-item"
                  >
                    <Box
                    ...
                    >
                      ...
                      >
                        <Box
                          ...
                          className="product-category-box-inner"
                        >
                          <Box
                          ...
                          >
                            <Typography
                              ...
                              className="product-category-placeholder"
                            >
                              Chọn ngành hàng
                            </Typography>
                          </Box>
                          <SvgIcon
                            ...
                            className="product-category-icon shopee-icon"
              ...
              <Box
                ...
                className="apply-suggestion-alert"
